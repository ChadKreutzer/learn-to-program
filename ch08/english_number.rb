def englishNumber number
  ...
  left  = number
  write = left/places          # How many hundreds left to write out?
  left  = left - write*places  # Subtract off those hundreds.

  if write > 0
    # Now here's a really sly trick:
    hundreds  = englishNumber write
    numString = numString + hundreds + ' ' + big_number
